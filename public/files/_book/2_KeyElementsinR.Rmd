...
```{r CorrectName, eval = FALSE, exercise = TRUE}
...
```{r checkCaseSensitiveName, eval = FALSE, exercise=TRUE}
...
```{r UKPopulation, eval=F, exercise=TRUE}
...
```{r load_tidyverse, eval=F, echo=TRUE, exercise = TRUE}
